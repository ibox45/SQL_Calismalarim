...
select distinct isim,sirket from personel where sirket in('Honda' ,'Ford' ,'Tofas');
...
select id, sehir as sehir_veya_telno, maas as maas_veya_cocuksayisi from personel where id=123456789
union
select * from personel_bilgi where id=123;
