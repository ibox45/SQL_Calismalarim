...
select A.sirket_id, sirket_isim, siparis_id, siparis_tarihi from sirketler as A
...
-- P: personel tablo
-- B: bolumler tablo
select  bolum_isim, personel_isim  from bolumler as B
...
-- P: personel tablo
-- B: bolumler tablo
select personel_isim, bolum_isim from bolumler as B
left join personel as P
on B.bolum_id=P.bolum_id
...
right join bolumler as B
on P.bolum_id=B.bolum_id
order by bolum_isim desc, maas;

-- herhangi bir bolumde kaydı olmasa da personel isni de gozuksun derse full join yapmalıyız.
select personel_isim, bolum_isim, maas from personel as P
...
------------------------------------------------------------------------------*/   
select bolum_isim, personel_isim, maas, (select personel_isim from personel where personel_id=P.mudur_id) as mudur_ismi from personel as P
left join bolumler as B
on  P.bolum_id=B.bolum_id
having   mudur_ismi in('HARUN','EMINE');
