...
select urun_isim, musteri_isim from nisan where urun_isim in(select urun_isim from mart where mart.urun_isim=nisan.urun_isim);
...
select urun_isim, musteri_isim from nisan where urun_isim not in(select urun_isim from mart where  mart.urun_isim=nisan.urun_isim);
