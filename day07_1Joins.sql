...
select ders_id, ders_ismi, ders_saati from qa_dersler where ders_id in(select ders_id from developer_dersler); -- 1. yol

select qa_dersler.ders_id, qa_dersler.ders_ismi, qa_dersler.ders_saati from qa_dersler, developer_dersler where qa_dersler.ders_id=developer_dersler.ders_id; -- 2. yol

select developer_dersler.ders_id, developer_dersler.ders_ismi, developer_dersler.ders_saati from qa_dersler, developer_dersler where qa_dersler.ders_id=developer_dersler.ders_id;  -- 2. yolun aynısı
...
/*=============================== INNER JOIN  ==================================
    ...
    ON tablo1.sutun = tablo2.sutun; -- ortak olan sütunlar buraya yazılır
================================================================================ */
...
on A.ders_id=B.ders_id; -- 2 tabloyu burada birleştirdik.
