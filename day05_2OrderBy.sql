...
select * from kisiler limit 10,2;   -- 10dan basla 10 hariç  2 tanesını getir.
...
select * from kisiler order by maas desc limit 0,3;   -- 0 dan basla 3 tanesini getir 1,2,3
...
select * from kisiler order by maas desc limit 3,3;  -- 3den basla 3 hariç 3 tanesini getir.
